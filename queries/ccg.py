def hr_ccg(startfyear,table):
    ...
    hr_ccg_str = f'''
        ...
        (
        SELECT
                nextsup_pref_order = ROW_NUMBER() OVER (PARTITION BY #TEMP3.CCG_Code ORDER BY HC2.Count,#TEMP3.AgeBand, #TEMP3.Sex),
        ...
        JOIN #TEMP3
        ON HC2.CCG_Code = #TEMP3.CCG_Code
        ...
        SELECT 
                ...
                N.AgeBand,
                N.Sex,
                SupNext = ROW_NUMBER()OVER(PARTITION BY N.CCG_Code
...
def kr_ccg(startfyear,table):
    ...
    kr_ccg_str = f'''
        ...
        (
        SELECT
                nextsup_pref_order = ROW_NUMBER() OVER (PARTITION BY #TEMP3.CCG_Code ORDER BY KC2.Count,#TEMP3.AgeBand, #TEMP3.Sex),
        ...
        JOIN #TEMP3
        ON KC2.CCG_Code = #TEMP3.CCG_Code
